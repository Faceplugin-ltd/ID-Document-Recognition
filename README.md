...
**API server** in Docker — test with Postman, curl, or the local Gradio demo (`python3 demo`) covering Result, Security, Images, and Raw JSON.
...
The Docker image is **API/SDK server only** (no Gradio). For a local FacePlugin Document Reader demo in the browser — Result, Security, Images, and Raw JSON — on the host (API must already be running on port 8082):
...
<p align="center">
 <img src="assets/screenshots/demo-ui-result.png" alt="FacePlugin Document Reader Linux demo — Result tab with OCR, MRZ, barcode, and verification" width="900"/>
</p>

<p align="center">
 <img src="assets/screenshots/demo-ui-security.png" alt="FacePlugin Document Reader Linux demo — Security tab with authenticity and document liveness checks" width="900"/>
</p>

<p align="center">
 <img src="assets/screenshots/demo-ui-images.png" alt="FacePlugin Document Reader Linux demo — Images tab with portrait, signature, and barcode crops" width="900"/>
</p>
<p align="center">
 <img src="assets/screenshots/demo-ui-raw.png" alt="FacePlugin Document Reader Linux demo — Raw JSON API response" width="900"/>
</p>
